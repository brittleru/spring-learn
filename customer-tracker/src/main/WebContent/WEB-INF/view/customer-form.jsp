...
<head>
  ...
  <title>Customer Form - Add customer</title>
</head>
<body>
  ...
  <div class="container main-content">
    <div class="form-content">
      ...
      <form:form class="" action="save-customer" modelAttribute="customer" method="post">

        <%-- need to associate this data with customer id --%>
        <%-- to set the content of the original customer --%>
        <%-- with the new content of the updated customer --%>
        <form:hidden path="id" />
      ...
      <div class="navigate-back">
        <p>
          <a class="btn btn-secondary" href="${pageContext.request.contextPath}/customer/list">Back to the Customers List</a>
        </p>
      </div>
