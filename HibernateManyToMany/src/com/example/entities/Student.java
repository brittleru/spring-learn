...
public class Student {
    ...
    @ManyToMany(fetch = FetchType.LAZY,  // we don't want to get all the courses at once
    ...
    @JoinTable(
            ...
            joinColumns = @JoinColumn(name = "student_id"),       // reference to the student (this class)
            inverseJoinColumns = @JoinColumn(name = "course_id")  // actual course from the other-side (the other class)
    )
